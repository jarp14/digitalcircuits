 ...
 * @generated
 */
public class OrNameTypeEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.OrNameTypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public OrNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DigitalParserProvider.getParser(DigitalElementTypes.Or_2006, getParserElement(),
					DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.OrNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
