 ...
 * </p>
 * <ul>
 *   <li>{@link digital.impl.AndImpl#getType <em>Type</em>}</li>
 *   <li>{@link digital.impl.AndImpl#getInput_x <em>Input x</em>}</li>
 *   <li>{@link digital.impl.AndImpl#getInput_y <em>Input y</em>}</li>
 *   <li>{@link digital.impl.AndImpl#getOutput_z <em>Output z</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndImpl extends GateImpl implements And {
	/**
	...
	protected EClass eStaticClass() {
		return DigitalPackage.Literals.AND;
	}
	...
	public void setInput_x(Value newInput_x) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.AND__INPUT_X, oldInput_x, input_x));
	}
	...
	public void setInput_y(Value newInput_y) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.AND__INPUT_Y, oldInput_y, input_y));
	}
	...
	public void setOutput_z(Value newOutput_z) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.AND__OUTPUT_Z, oldOutput_z, output_z));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DigitalPackage.AND__TYPE:
				return getType();
			case DigitalPackage.AND__INPUT_X:
				return getInput_x();
			case DigitalPackage.AND__INPUT_Y:
				return getInput_y();
			case DigitalPackage.AND__OUTPUT_Z:
				return getOutput_z();
		}
