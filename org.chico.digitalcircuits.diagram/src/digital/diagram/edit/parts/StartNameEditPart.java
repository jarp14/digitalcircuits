 ...
 * @generated
 */
public class StartNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StartNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DigitalParserProvider.getParser(DigitalElementTypes.Start_2009, getParserElement(),
					DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.StartNameEditPart.VISUAL_ID));
		}
		return parser;
	}
