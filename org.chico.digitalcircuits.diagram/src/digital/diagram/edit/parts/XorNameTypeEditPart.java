 ...
 * @generated
 */
public class XorNameTypeEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.XorNameTypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public XorNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DigitalParserProvider.getParser(DigitalElementTypes.Xor_2008, getParserElement(),
					DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.XorNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new XorLabelFigure();
	}

	/**
	 * @generated
	 */
	public class XorLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public XorLabelFigure() {
			this.setText("Xor");
		}
