 ...
 * @generated
 */
public class BufferItemSemanticEditPolicy extends DigitalBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public BufferItemSemanticEditPolicy() {
		super(DigitalElementTypes.Buffer_2002);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DigitalVisualIDRegistry.getVisualID(incomingLink) == RelationEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (DigitalVisualIDRegistry.getVisualID(outgoingLink) == RelationEditPart.VISUAL_ID) {
