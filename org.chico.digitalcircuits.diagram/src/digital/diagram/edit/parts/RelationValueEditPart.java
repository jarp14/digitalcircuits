 ...
 * @generated
 */
public class RelationValueEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.RelationValueEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public RelationValueEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DigitalParserProvider.getParser(DigitalElementTypes.Relation_4001, getParserElement(),
					DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.RelationValueEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null, DigitalEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
