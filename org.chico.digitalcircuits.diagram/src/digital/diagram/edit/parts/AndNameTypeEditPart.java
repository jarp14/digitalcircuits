 ...
 * @generated
 */
public class AndNameTypeEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.AndNameTypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public AndNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DigitalParserProvider.getParser(DigitalElementTypes.And_2001, getParserElement(),
					DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.AndNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
