...
import digital.diagram.edit.policies.DigitalTextSelectionEditPolicy;
 ...
 * @generated
 */
public class BufferNameTypeEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.BufferNameTypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public BufferNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new DigitalTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DigitalParserProvider.getParser(DigitalElementTypes.Buffer_2002, getParserElement(),
					DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.BufferNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, DigitalEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new BufferLabelFigure();
	}

	/**
	 * @generated
	 */
	public class BufferLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public BufferLabelFigure() {
			this.setText("Buffer");
		}
