...
/**
 * This is the item provider adapter for a {@link digital.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_value_feature", "_UI_Link_type"),
				 DigitalPackage.Literals.LINK__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Value labelValue = ((Link)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Link.class)) {
			case DigitalPackage.LINK__VALUE:
