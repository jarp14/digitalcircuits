 ...
 * </p>
 * <ul>
 *   <li>{@link digital.impl.XorImpl#getType <em>Type</em>}</li>
 *   <li>{@link digital.impl.XorImpl#getInput_x <em>Input x</em>}</li>
 *   <li>{@link digital.impl.XorImpl#getInput_y <em>Input y</em>}</li>
 *   <li>{@link digital.impl.XorImpl#getOutput_z <em>Output z</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XorImpl extends GateImpl implements Xor {
	/**
	 ...
	 * @ordered
	 */
	protected static final String TYPE_EDEFAULT = "XOR";
	...
	protected EClass eStaticClass() {
		return DigitalPackage.Literals.XOR;
	}
	...
	public void setInput_x(Value newInput_x) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.XOR__INPUT_X, oldInput_x, input_x));
	}
	...
	public void setInput_y(Value newInput_y) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.XOR__INPUT_Y, oldInput_y, input_y));
	}
	...
	public void setOutput_z(Value newOutput_z) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.XOR__OUTPUT_Z, oldOutput_z, output_z));
	}
