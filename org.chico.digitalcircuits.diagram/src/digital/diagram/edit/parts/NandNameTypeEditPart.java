 ...
 * @generated
 */
public class NandNameTypeEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.NandNameTypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public NandNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DigitalParserProvider.getParser(DigitalElementTypes.Nand_2003, getParserElement(),
					DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.NandNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new NandLabelFigure();
	}

	/**
	 * @generated
	 */
	public class NandLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public NandLabelFigure() {
			this.setText("Nand");
		}
