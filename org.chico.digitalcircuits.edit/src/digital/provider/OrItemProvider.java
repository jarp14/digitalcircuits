...
/**
 * This is the item provider adapter for a {@link digital.Or} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Or_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Or_type_feature", "_UI_Or_type"),
				 DigitalPackage.Literals.OR__TYPE,
				 false,
				 false,
				 false,
	...
	protected void addInput_xPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Or_input_x_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Or_input_x_feature", "_UI_Or_type"),
				 DigitalPackage.Literals.OR__INPUT_X,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addInput_yPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Or_input_y_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Or_input_y_feature", "_UI_Or_type"),
				 DigitalPackage.Literals.OR__INPUT_Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOutput_zPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Or_output_z_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Or_output_z_feature", "_UI_Or_type"),
				 DigitalPackage.Literals.OR__OUTPUT_Z,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
