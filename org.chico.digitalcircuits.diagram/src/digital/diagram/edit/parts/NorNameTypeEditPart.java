 ...
 * @generated
 */
public class NorNameTypeEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.NorNameTypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public NorNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DigitalParserProvider.getParser(DigitalElementTypes.Nor_2004, getParserElement(),
					DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.NorNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new NorLabelFigure();
	}

	/**
	 * @generated
	 */
	public class NorLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public NorLabelFigure() {
			this.setText("Nor");
		}
