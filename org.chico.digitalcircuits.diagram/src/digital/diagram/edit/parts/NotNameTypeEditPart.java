 ...
 * @generated
 */
public class NotNameTypeEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.NotNameTypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public NotNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DigitalParserProvider.getParser(DigitalElementTypes.Not_2005, getParserElement(),
					DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.NotNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new NotLabelFigure();
	}

	/**
	 * @generated
	 */
	public class NotLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public NotLabelFigure() {
			this.setText("Not");
		}
