...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Nand</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link digital.impl.NandImpl#getType <em>Type</em>}</li>
 *   <li>{@link digital.impl.NandImpl#getInput_x <em>Input x</em>}</li>
 *   <li>{@link digital.impl.NandImpl#getInput_y <em>Input y</em>}</li>
 *   <li>{@link digital.impl.NandImpl#getOutput_z <em>Output z</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NandImpl extends GateImpl implements Nand {
	/**
	 ...
	 * @ordered
	 */
	protected static final String TYPE_EDEFAULT = "NAND";
	...
	protected EClass eStaticClass() {
		return DigitalPackage.Literals.NAND;
	}
	...
	public void setInput_x(Value newInput_x) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.NAND__INPUT_X, oldInput_x, input_x));
	}
	...
	public void setInput_y(Value newInput_y) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.NAND__INPUT_Y, oldInput_y, input_y));
	}
	...
	public void setOutput_z(Value newOutput_z) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.NAND__OUTPUT_Z, oldOutput_z, output_z));
	}
