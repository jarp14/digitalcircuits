...
/**
 * This is the item provider adapter for a {@link digital.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationItemProvider extends LinkItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DigitalPackage.Literals.RELATION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DigitalPackage.Literals.RELATION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		Value labelValue = ((Relation)object).getValue();
