 ...
 * @generated
 */
public class EndNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EndNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DigitalParserProvider.getParser(DigitalElementTypes.End_2010, getParserElement(),
					DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.EndNameEditPart.VISUAL_ID));
		}
		return parser;
	}
