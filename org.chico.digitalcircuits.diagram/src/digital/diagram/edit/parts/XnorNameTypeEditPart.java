 ...
 * @generated
 */
public class XnorNameTypeEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.XnorNameTypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public XnorNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DigitalParserProvider.getParser(DigitalElementTypes.Xnor_2007, getParserElement(),
					DigitalVisualIDRegistry.getType(digital.diagram.edit.parts.XnorNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new XnorLabelFigure();
	}

	/**
	 * @generated
	 */
	public class XnorLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public XnorLabelFigure() {
			this.setText("Xnor");
		}
