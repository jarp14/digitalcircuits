...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Nor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link digital.impl.NorImpl#getType <em>Type</em>}</li>
 *   <li>{@link digital.impl.NorImpl#getInput_x <em>Input x</em>}</li>
 *   <li>{@link digital.impl.NorImpl#getInput_y <em>Input y</em>}</li>
 *   <li>{@link digital.impl.NorImpl#getOutput_z <em>Output z</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NorImpl extends GateImpl implements Nor {
	/**
	 ...
	 * @ordered
	 */
	protected static final String TYPE_EDEFAULT = "NOR";
	...
	protected EClass eStaticClass() {
		return DigitalPackage.Literals.NOR;
	}
	...
	public void setInput_x(Value newInput_x) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.NOR__INPUT_X, oldInput_x, input_x));
	}
	...
	public void setInput_y(Value newInput_y) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.NOR__INPUT_Y, oldInput_y, input_y));
	}
	...
	public void setOutput_z(Value newOutput_z) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DigitalPackage.NOR__OUTPUT_Z, oldOutput_z, output_z));
	}
